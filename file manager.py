...
#funtion to creat the folders if the user does not have them
def createFolder():
    os.mkdir(doc)
    os.mkdir(img)
    os.mkdir(aud)
...
#asking if the user wants to creat the folders
usrInput = input("Do you want to create Directories? Y or N")
if usrInput.upper() == "Y":
    createFolder()
else:
    pass
...
for x in dir:
    ...
    if fileExt == ".lnk" or fileExt == ".url":
        shutil.move(loc+x, loc+"Shortcuts")
    else:
        pass
    pass
